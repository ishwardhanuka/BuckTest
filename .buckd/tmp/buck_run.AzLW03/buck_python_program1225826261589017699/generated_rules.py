...
@provide_as_native_rule
def xcode_workspace_config(name, action_config_names=None, additional_scheme_actions=None, environment_variables=None, explicit_runnable_path=None, extra_schemes=None, extra_shallow_targets=None, extra_targets=None, extra_tests=None, is_remote_runnable=None, labels=None, launch_style=None, licenses=None, notification_payload_file=None, src_target=None, target_compatible_with=None, watch_interface=None, workspace_name=None, visibility=None, within_view=None, build_env=None):
    add_rule({
        ...
        'licenses': licenses,
        'notificationPayloadFile': notification_payload_file,
...
@provide_as_native_rule
def go_binary(name, assembler_flags=None, compiler_flags=None, deps=None, external_linker_flags=None, labels=None, licenses=None, link_mode=None, link_style=None, linker_flags=None, platform=None, resources=None, srcs=None, target_compatible_with=None, visibility=None, within_view=None, build_env=None):
    add_rule({
        'buck.type': 'go_binary',
        'name': name,
...
@provide_as_native_rule
def go_test(name, assembler_flags=None, compiler_flags=None, contacts=None, coverage_mode=None, deps=None, external_linker_flags=None, labels=None, library=None, licenses=None, link_mode=None, link_style=None, linker_flags=None, package_name=None, platform=None, resources=None, run_test_separately=None, srcs=None, target_compatible_with=None, test_rule_timeout_ms=None, visibility=None, within_view=None, build_env=None):
    add_rule({
        'buck.type': 'go_test',
        'name': name,
        'assemblerFlags': assembler_flags,
